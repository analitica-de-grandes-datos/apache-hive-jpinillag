...
CREATE TABLE respuesta AS SELECT c2, key, value FROM data LATERAL VIEW EXPLODE(c6) List;

INSERT OVERWRITE LOCAL DIRECTORY './output' ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' SELECT c2, SUM(value) FROM respuesta GROUP BY c2;